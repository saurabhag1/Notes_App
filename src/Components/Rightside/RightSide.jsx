import StyleRightSidePannel from "./RightSide.module.css";
    ...
    <>
      <div className={StyleRightSidePannel.rightSidePannel}>
        <div className={StyleRightSidePannel.image}>
          ...
          <div className={StyleRightSidePannel.endToEnd}>
            <img
              src="assets/endToEndEncryptedImage.svg"
              alt="endToEndEncryptedImage"
            />{" "}
