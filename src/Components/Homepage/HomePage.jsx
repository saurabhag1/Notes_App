import LeftSidePannel from "../LeftSide/LeftSide";
import RightSidePannel from "../Rightside/RightSide";
...
const HomeMainPage = () => {
  ...
  const handleSubmit = (e) => {
    if (submitCheck()) {
      const isGroupNameExists = existingGroupNames.includes(groupName);
      ...
      if (isGroupNameExists) {
        ...
        // Store updated group names in localStorage
        localStorage.setItem(
          "groupNames",
          JSON.stringify([...existingGroupNames, groupName])
        );
  ...
  useEffect(() => {
    ...
    setExistingGroupNames(storedGroupNames);
  }, []);
  ...
  //     const existingNames = await fetchExistingGroupNames();
  //     setExistingGroupNames(existingNames);
  //   };
